...
| `--strict` | Exit with code 1 if there are any errors |
...
Output of `blueprinter build`. Contains all parsed contracts:
...
Output of `blueprinter resolve`. Contains selected modules with transitive dependencies:

```json
{
  "modules": [
    { "name": "billing", "source": "explicit", "hardDeps": [...], "softDeps": [...] },
    { "name": "payments", "source": "hard-dep", ... }
  ],
  "core": [...],
  "warnings": []
}
...
Schema: `schemas/resolved-set.json`
