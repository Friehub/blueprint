// temporal.test.ts
// Auto-generated conformance test for temporal → jobs
// Do not edit manually

import { TemporalAdapter } from '../adapters/jobs/temporal';
import type { JobsContract } from '../interfaces/jobs';

describe('TemporalAdapter implements JobsContract', () => {
  const adapter: JobsContract = new TemporalAdapter({
    temporal_url: 'test',
    namespace: 'test'
  });
