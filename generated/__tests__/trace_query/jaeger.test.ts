// jaeger.test.ts
// Auto-generated conformance test for jaeger → trace_query
// Do not edit manually

import { JaegerAdapter } from '../adapters/trace_query/jaeger';
import type { TraceQueryContract } from '../interfaces/trace_query';

describe('JaegerAdapter implements TraceQueryContract', () => {
  const adapter: TraceQueryContract = new JaegerAdapter({
    endpoint: 'test'
  });
