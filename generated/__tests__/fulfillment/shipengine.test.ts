// shipengine.test.ts
// Auto-generated conformance test for shipengine → fulfillment
// Do not edit manually

import { ShipengineAdapter } from '../adapters/fulfillment/shipengine';
import type { FulfillmentContract } from '../interfaces/fulfillment';

describe('ShipengineAdapter implements FulfillmentContract', () => {
  const adapter: FulfillmentContract = new ShipengineAdapter({
    api_key: 'test'
  });
