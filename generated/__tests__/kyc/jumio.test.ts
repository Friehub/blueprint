// jumio.test.ts
// Auto-generated conformance test for jumio → kyc
// Do not edit manually

import { JumioAdapter } from '../adapters/kyc/jumio';
import type { KycContract } from '../interfaces/kyc';

describe('JumioAdapter implements KycContract', () => {
  const adapter: KycContract = new JumioAdapter({
    api_token: 'test',
    api_secret: 'test',
    subdomain: 'test'
  });
